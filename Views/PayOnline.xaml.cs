...
public partial class PayOnline : ContentPage
{
    ...
    public PayOnline(string roomID, string roomType, double roomRate, string paycode,DateTime dateIn, DateTime dateOut ) : this()
    {
        ...
        if (buttonClicked)
        {
            ...
            else
            {
                ...
                if (paymentConfirmed)
                {
                    ...
                    {
                        Application.Current.MainPage = new PayOnlineReceipt(roomIDEntry.Text,roomTypeEntry.Text,Convert.ToDouble(roomRateEntry.Text),txtPayCode.Text,txtCreditCard.Text,txtEmail.Text);
                    }
                }
